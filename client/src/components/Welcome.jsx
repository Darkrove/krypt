...
const commonStyles = "min-h-[50px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-solid border-[0.5px] border-gray-400 text-sm font-light text-white";
      ...
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start items-start flex-col mf:mr-10'>
          ...
          <button 
            ...
            className='w-full border-none flex flex-row justify-center items-center my-5 bg-[#2952e3] rounded-full cursor-pointer hover:bg-[#2546bd]'>
          ...
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
            <div className="flex justify-between flex-col w-full h-full">
              <div className="flex justify-between items-start">
                <div className="w-10 h-10 rounded-full border-solid border-2 border-white flex justify-center items-center">
            ...
            {isLoading
              ...
              : (
                <button
                  ...
                  className="text-white w-full mt-2 border-[1px] p-2 bg-transparent border-solid border-[#3d4f7c] hover:bg-[#3d4f7c] rounded-full cursor-pointer"
                >
                  Send now
                </button>
              )}
